...
export function NavbarDropDown({ buttonOptions,handleMouseOver,handleMouseLeave }: NavbarDropDownProps) {
  ...
  return (
    <>
      <div className="dropDown-container" onMouseEnter={handleMouseOver} onMouseLeave={handleMouseLeave}>
        <ul>

...
<div className="talismanesGrilla-top-container">
        <div className="talismanesGrilla-top-image-container"><img src={talisman} alt="Talisman-vista1" /></div>
        <div className="talismanesGrilla-top-image-container"><img src={talisman2} alt="Talisman-vista2" /></div>
      </div>
      <div className="talismanesGrilla-bottom-container">
    {ejemploTalismanesAnalogicos.map((talisman,i)=>{
      return(<div className="talismanesGrilla-bottom-image-container" key={i}><img src={talisman.image} alt={talisman.title} /></div>)
    })}
      </div>

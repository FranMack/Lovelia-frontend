...
function Login() {
  ...
  const { setEmail, setId, setName, setToken, setLastname, setSuscription,setTalismanActivated } =
    ...
    <section className="login-container efectoReveal">
      ...
      <form onSubmit={singUpForm.handleSubmit} className="login-form" action="">
        ...
        <h6>
          ...
          <strong onClick={()=>{linkTo("register")}}>Haz click aquí.</strong>
        </h6>
        ...
        <div className="login-button-container">
          <p ><span onClick={()=>{linkTo("forget-password")}}>¿Has olvidado tu contraseña?</span></p>

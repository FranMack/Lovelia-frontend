...
export const TalismanAnalogic2 = () => {
  ...
  <p>
  Podrás configurar tu propio talismán seleccionando<br/> cada elemento: <strong>modelo, material, piedra,<br/> intención.</strong><br/>
  Las piedras que empleamos son auténticas y están<br/>meticulosamente talladas a mano, lo que significa<br/> que <strong>cada talismán será verdaderamente único,<br/> igual que tú.</strong>
  </p>

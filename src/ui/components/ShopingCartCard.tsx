...
export const ShopingCartCard = ({id,image,product,model,material,rock,chain,intention,price}:ShopingCartCardOptions) => {

const{setShopingCartItems,shopingCartItems} =useContext(ShopingCartContext)

...
export function Footer(){
    ...
    const mapaDelSitio=[{title:"Inicio",path:"/"},{title:"Talismán",path:"talisman-landing"},{title:"Meditaciones",path:"meditations"},{title:"Intenciones",path:"intenciones"},{title:"Tienda",path:"tienda"},{title:"Blog",path:"blog"}];
    ...
    const nosotros=[{title:"Acerca de nosotros",path:"/"},{title:"Terminos y condiciones",path:"terminos-y-condiciones"},{title:"Políticas de devolución",path:""},{title:"Preguntas frecuentes",path:""},{title:"Contáctanos",path:"contacto"}];
    ...
    return(
        <footer className="footer">
            ...
            <div className="footer-top-container">
                ...
                <FacebookIcon />
                <InstagramIcon onClick={()=>redirecTo("https://www.instagram.com/lovelia.me/")}/>
                <TwitterIcon/>

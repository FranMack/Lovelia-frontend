...
export const Chronometer = ({ playTrack }: ChronometerOptions) => {
  ...
  const { setAudioType, audioType, trackIndex, setTrackIndex } =
  ...
  return (
    <div className="chronometer-container">
      <div className="icon-container">
        <CloseIcon onClick={exitChronometer} />
      </div>
      <div className="chorometer-center-container">
        ...
        <div className="buttons-container">
          {!started ? (
            <Button text="Iniciar" onClick={startTimer} />
          ) : chronometer && started ? (
            <Button text="Detener" onClick={stopTimer} />
          ) : (
            <Button text="Continuar" onClick={continueTimer} />
          )}

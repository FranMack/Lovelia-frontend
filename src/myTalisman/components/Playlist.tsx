...
export function Playlist({ sounds,audioType,trackIndex,playTrack,pauseTrack,restartTrack,playing }: DropdownOptions) {
      ...
      <div className="playlist-title-wrapper">
        ...
        <div className="playlist-section-container">
            ...
            <table className="playlist-sounds-table">
              ...
              {buttonFocusPosition==="sonidos lovelia" && sounds.map((item, i) => {
                return (
                  <tbody>
...
{ buttonFocusPosition==="meditaciones lovelia" && sounds.map((item, i) => {
                return (
                  <tbody>

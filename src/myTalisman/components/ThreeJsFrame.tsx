      ...
      const playUserSoundWithCount = () => {
        return new Promise((resolve) => {
          if (userSoundRef.current) {
            ...
            resolve(); // Si no hay referencia de sonido, resolver inmediatamente
          }
        });
      };
      ...
      {astrologicalInfo ? (
        <>
          ...
          {buttonFocusPosition === "activation" && (
            <Activation handleActivation={handleActivation} pauseTrack={pauseTrack} />
          )}

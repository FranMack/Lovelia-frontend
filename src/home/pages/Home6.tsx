      ...
      <div ref={animationRef} className="section6-home-internal-container left">
        <div className="section6-home-internal-text-container">
          <p>
            ...
            donde{" "}
            <strong>
              la tecnología y los saberes
              <br />
              ancestrales están al servicio de tu
              <br /> propósito.
            </strong>
            <br /> Te brindamos herramientas,
            <br /> experiencias y contenido para que
            <br /> puedas cocrear tu propia realidad,
            <br /> validando el poder de la intención, la
            <br /> energía y tu potencial.
            <br />
            <br />
            <br />

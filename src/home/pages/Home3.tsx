      ...
      <div className="section3-home-internal-container right">
        <div className="section3-home-internal-text-container">
          ...
          <p>
            <span>
              {" "}
              Existe el poder de transformar los pensamientos en realidades
              durante el proceso de búsqueda de la plenitud y la realización
              personal.
            </span>
          </p>
          ...
          <p>
            ...
            <strong>
              La intención es el punto de partida para todo cambio y creación
            </strong>
            , ya que se trata de la energía que dirige nuestros pensamientos,
            nuestras palabras y nuestras acciones hacia la manifestación de
            nuestros deseos más profundos, esos que están{" "}
            <strong>
              en conexión íntima con nuestra esencia, nuestros valores y nuestra
              visión del mundo
            </strong>
            .
          </p>

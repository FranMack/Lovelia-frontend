  ...
  return (
    <section className="buyDigitalTalisman-container efectoReveal">
     {popUp && <PopUp linkTo={linkTo} closePopUp={togglePopUp}/>}
      <div style={{opacity: popUp ? "0.4":"1"}} className="buyDigitalTalisman-internal-container">
      ...
      <div  className="buyDigitalTalisman-internal-container right" style={{opacity: popUp ? "0.4":"1"}} >

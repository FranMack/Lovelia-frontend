...
export const blogNotes = [
...

  {
    ...
    paragraphs1: [
      ...
      'Desde el más mínimo movimiento hasta la creación de obras de arte, todo se gesta a partir de un impulso: la intención. Sin embargo, ésta va más allá de un simple deseo, ya que es capaz de moldear nuestra realidad física y su interacción con el universo, lo que nos convierte en cocreadores de nuestro destino.',
    ],
    paragraphs2: [
      'Basado en lo que percibimos, conocemos, aprendemos, recodamos, razonamos y hacemos, este impulso es el que vincula nuestros deseos más profundos con la realización espiritual y física, ya que está directamente relacionado al propósito de alcanzar la felicidad y de sentirnos plenos.',
      'Cuando alineamos nuestros pensamientos con nuestras aspiraciones, activamos este poderoso mecanismo que nos acerca a nuestras metas.',
      'Para lograrlo, es necesario sentirnos interconectados, comprometidos, tener claridad mental y creer profundamente en el proceso del universo. También sentir y pensar de manera positiva en que somos merecedores de todo lo bueno que la vida tiene para ofrecer y estar genuina y profundamente agradecidos por lo que la vida nos ha dado.',
      'El cultivo de la intención requiere autoindagación para discernir deseos profundos y establecer metas claras. Alimentarla mediante la visualización, la afirmación y la acción deliberada alinea nuestros pensamientos y acciones con nuestra visión, lo que permite generar un flujo continuo de energía positiva que nos impulsa hacia adelante.',
...

  {
    ...
    author: 'Lovelia',
    date: '03 de Septiembre del 2024',
    image1: amorIncondicional,
    image2: amorIncondicional,
    paragraphs1: [
...

  {
    ...
    author: 'Lovelia',
    date: '03 de Septiembre del 2024',
    image1: potencialInfinito,
    image2: potencialInfinito,
    paragraphs1: [

...
export function CheckOutDigital() {
  ...
  const [buttonFocusPosition, setButttonFocusPosition] =
    ...
    const [validationErrors,setValidationErrors]=useState({ locationValidation:false,
  ...
  const handleButtonFocus = (buttonName: string) => {
    if(buttonFocusPosition==="1. Datos usuario"){
      if (
        ...
        setValidationErrors({locationValidation:!location,
        ...
        setValidationErrors({ locationValidation:false,
          dayOptionValidation:false, 
          hourOptionValidation:false, 
          minuesOptionValidation:false, 
          yearOptionValidation:false, 
  ...
  const handleMeridiam = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    setValidationErrors({...validationErrors,meridiamOptionValidation:false})
  };
        ...
        <div  className="checkout-botton-container">
          ...
          >
            ...
            <div className="checkout-form">
              ...
              <input
              className={validationErrors.locationValidation ? "input-error":""}
                type="text"
                value={location}
              ...
              <div className="checkout-form-names-container">
                <div className="checkout-date-options-container">
                  <select
                    ...
                    className={validationErrors.dayOptionValidation ? "select-error" : ""}
                  >
                  ...
                  <select
                    ...
                    className={validationErrors.monthOptionValidation ? "select-error" : ""}
                  >
                  ...
                  <select
                    ...
                    className={validationErrors.yearOptionValidation ? "select-error" : ""}
                  >
              ...
              <div className="checkout-form-names-container">
                <div className="checkout-date-options-container">
                  <select
                    ...
                    className={validationErrors.hourOptionValidation ? "select-error" : ""}
                  >
                  ...
                  <select
                    ...
                    className={validationErrors.minuesOptionValidation ? "select-error" : ""}
                  >
                  ...
                  <select
                    ...
                    className={validationErrors.meridiamOptionValidation ? "select-error" : ""}
                  >
              ...
              { (Object.values(validationErrors).includes(true)) && <div className="warning-container">

          ...
          {buttonFocusPosition === "1. Identificación" ? (
            ...
            <div className="checkout-botton-left-container">
              ...
              <div className="checkout-form">
                ...
                { country==="Mexico" && <div className="facturacion-checkbox">
                    <label htmlFor="">
                ...
                {billing && (
                  <>
                    ...
                    <select name="billingTaxRegime"  onBlur={() => handleBlurBilling("taxRegime")}  onChange={billingForm.onInputChange}  value={billingTaxRegime}   className={
                        billingTaxRegimeErrors.length > 0 ? "billing-taxRegime input-error" : "billing-taxRegime"

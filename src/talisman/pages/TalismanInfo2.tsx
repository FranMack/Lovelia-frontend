...
const frontPageInfo: FrontPage1Options = {
  image: background,
  text:"LOVELIA TE PROPONE ABRIRTE A NUEVAS EXPERIENCIAS DE CONEXIÓN INTERIOR, TRANSFORMANDO TU REALIDAD, CREANDO TU PROPIA FORMA DE ANDAR, ADQUIRIENDO EL PODER DE ELEGIR, SIENDO PROTAGONISTA DE TU VIDA QUE ES ÚNICA E IRREPETIBLE.",
  color: "#ffffff",
  button: false,

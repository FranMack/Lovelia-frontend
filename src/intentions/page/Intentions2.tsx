...
const frontPageInfo: FrontPage1Options = {
  image: wallpaper,
  text:"CUANDO AMPLIAMOS NUESTRA CONCIENCIA, EVOLUCIONAMOS Y DESPERTAMOS LAS CAPACIDADES, TALENTOS Y DONES QUE TENÍAMOS DORMIDOS. LAS INTENCIONES LOVELIA SON 8 CONCEPTOS QUE CONSIDERAMOS FUNDAMENTALES PARA EL DESARROLLO DE LA CREATIVIDAD CONSCIENTE.",
  color: "#ffff",
  button:false,

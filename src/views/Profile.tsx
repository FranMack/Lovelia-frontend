...
const datosCompras: DatosCompra[] = [
  {
    ...
    fecha: "12/05/2024",
    precio: 1000.0,
    image: [talismanAnalogico, talismanAnalogico, talismanAnalogico],
  },
  {
    producto: "Talisman Aura",
    numPedido: "LA1545",
  ...
  useEffect(() => {
    if (email) {
      axios
        ...
        .then((response) => {
          setShopingHistory(response.data);
        })
        .catch((error) => {
          console.log(error);
        });
          ...
          <div className="profile-botton-container">
            <div className="profile-botton-internal-left-container">
              ...
              <div className="profile-item-info-container">
                ...
                <input
                  type="text"
                  value={subscription ? "Activa" : "Inactiva"}
                />
              </div>
            ...
            <div className="profile-botton-internal-right-container">
              ...
              <div className="profile-botton-image-container">
                {subscription ? (
                  <img
                    className="profile-talismanDigital-image"
                    src={talismanDigital}
              ...
              <div className="auxiliar-button-container">
                {subscription ? (
                  <Button
                    text="Ir a talisman digital"
                    onClick={linkToMyTalisman}
                  />
                ) : (
                  <Button
                    text="Adquiere tu talismán"
                    ...
                    shopingHistory.map((item, i) => {
                      return (
                        <div
                          ...
                          key={item[0].order_id}
                          className="profile-historial-item-card"
                        >
                ...
                <div className="profile-historial-internal-right-container">
                  ...
                  <div className="profile-historial-detalle-container">
                    <div className="profile-historial-detalle-center-container">
                      <p>{`Nro. pedido:${
                        shopingHistory.length > 0 &&
                        shopingHistory[index][0].order_id
                      }`}</p>
                      <p>{`Fecha:${
                        shopingHistory.length > 0 &&
                        shopingHistory[index][0].date
                      }`}</p>
                      <hr />
                      ...
                      <table>
                        <tr>
                          <th className="table-title">
                            Producto{" "}
                            <span>{`(Material - Piedra - Colgado )`}</span>
                          </th>
                          <th className="table-title">Precio</th>
                        </tr>
                        {shopingHistory.length > 0 &&
                          shopingHistory[index].map((item) => {
                            return (
                              <tr>
                      ...
                      <div className="envio-info-container">
                        <div className="envio-info-auxiliar-container">
                          ...
                          <p>
                            {shopingHistory.length > 0 &&
                              shopingHistory[index][0].address}
                          </p>
                          <p>
                            {shopingHistory.length > 0 &&
                              shopingHistory[index][0].postalCode}
                          </p>
                          <p>
                            {shopingHistory.length > 0 &&
                              shopingHistory[index][0].receiver}
                          </p>
                        ...
                        <div className="envio-info-auxiliar-container">
                          ...
                          <p>
                            {shopingHistory.length > 0 &&
                              shopingHistory[index][0].payment_method}
                          </p>
                        </div>
                      </div>
                    </div>
